...
alias bashprof='subl .bashrc'
#       (.bashrc)
alias bashrc-conf='open -a Sublime\ Text ~/.bashrc'

#  PHP
alias phpconf='open -a Sublime\ Text /Applications/MAMP/bin/php/php5.5.10/conf/php.ini'
...
alias lr='~/Google\ Drive/Developer/git\ repositories'
...
# Go To => Dot Files
alias dot='/Users/alexcory/Google\ Drive/Developer/git\ repositories/dotfiles'
