...
var Emitter = require('events').EventEmitter; 					// Event emitters make it possible to send a piece of data to any number of listeners
...
flightEmitter.on('arrival', function (flight) {
	console.log('Flight Has Arrived: ' + flight.data.number);
});
