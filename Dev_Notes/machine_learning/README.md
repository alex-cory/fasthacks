...
- [Wikipedia](https://www.wikiwand.com/en/Supervised_learning)
- Tasks:
 - pattern recognition
 - regression
 - speech recognition
...
- [Wikipedia](https://www.wikiwand.com/en/Unsupervised_learning)
- Tasks:
 - Clustering
...
### Reinforcement Learning
 ...
 - [Wikipedia](https://www.wikiwand.com/en/Reinforcement_learning)
 - Tasks:
  - control problems
  - games
...
### [Classification](./classification.md)  
 ...
 - [Wikipedia](https://www.wikiwand.com/en/Statistical_classification)

### [Regression](./regression.md)
 - In Models, regression analysis is a statistical process for estimating the relationships among variables.
